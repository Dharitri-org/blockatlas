...
type StatusDetails struct {
	Round float64 `json:"and_current_round"`
	Epoch float64 `json:"and_epoch_number"`
	Nonce float64 `json:"and_nonce"`
}
...
func (tx *Transaction) TxTimestamp(blockRound uint64) time.Duration {
	...
	// The transactions fetched by querying the endpoint "address/and1.../transactions" come from our central Elastic Search database, and their timestamp refers to the moment of *including* those transactions in shard blocks (detail: at destination).
